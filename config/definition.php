    ...
    $rootNode
        ...
        ->children()
            ...
            ->arrayNode('route_ignore_patterns')
                ...
                ->defaultValue([])
            ->end()
            ->booleanNode('purge_on_entity_change')
                ->info('Whether entity changes trigger purge requests, can be overridden at runtime using the entity change purge switcher.')
                ->defaultTrue()
            ->end()
            ->booleanNode('test')
                ->info('Enables test implementations of services, e.g. an entity change purge switcher whose state can be overridden globally.')
                ->defaultFalse()
            ->end()
