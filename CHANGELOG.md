...
- Mark `CreatedEntityRouteProvider`, `UpdatedEntityRouteProvider` and `RemovedEntityRouteProvider` as `@internal` by @HypeMC
  in https://github.com/sofascore/purgatory-bundle/pull/157
...
- Use `.kernel.config_dir` as default mapping path when available by @klezaic
  in https://github.com/sofascore/purgatory-bundle/pull/149
